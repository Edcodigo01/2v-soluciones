...
@section("content")
    ...
    <div class="text-center relative" style="overflow:hidden">
      ...
      <img src="{{asset('public/images/contactenos/operadora.jpg')}}" alt="" style="position:fixed;top:0;left:0;right:0;z-index:-5;height:450px;width:100%;object-fit:cover;object-position:left">
        <div class="container-title" style="">
            <span class=" px-3 py-2" style="display:inline-block">
                <div class="row m-auto" style="width:100%">
                    <div class="col-12">
                        <h2 class="text-center text-white mt-1 titleArticle" ><i class="fas fa-comments"></i>  Contáctanos</h2>
                    </div>
                </div>
            </span>
        </div>
               ...
               <div class="col-md-6 col-xl-3 mb-4">
                   <div class="card  " style="height:100%">
                       <div class="card-body p-3">
                           ...
                           <p class="font500 text-center">Av. Mariana de Jesús y Jorge Juan N31-120, Quito - Ecuador</p>
                       </div>
                   </div>
               </div>
                       ...
                       <div class="card-body">
                           ...
                           <div class="row">
                              ...
                              {{-- <div class="form-group col-12">
                                   <label class="labelInput" for="">Asunto:</label>
