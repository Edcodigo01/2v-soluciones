...
@section("content")
   ...
   <div class="paralax" id="imgP">
      <div class="overlay" style="background:rgba(0, 119, 242, 0.24)">
         ...
         <div class="row m-auto" style="width:100%">
             <div class="col-12">
                <div class="text" style="max-width:95%">
                 ...
                 <h3 class="text text-center text-white font400 wow fadeInLeft" data-wow-duration="2s">Tesis, deberes académicos y más...</h3>
                 <br>
                 <br>
            ...
            <div class="row m-auto" style="width:100%">
               ...
               <div class="col-lg-3 col-sm-4 col-6">
                  <div style="max-width:300px;margin:auto">
                     ...
                     <h6 class="text-center font600 mb-4" > Equipo multidisciplinario y altamente calificado.</h6>
               ...
               <div class="col-lg-3 col-sm-4 col-6">
                  <div style="max-width:300px;margin:auto">
                     ...
                     <h6 class="text-center font600 mb-4" > Cumplimiento de normas metodológicas y de contenido.</h6>
               ...
               <div class="col-lg-3 col-sm-4 col-6">
                  <div style="max-width:300px;margin:auto">
                     ...
                     <h6 class="text-center font600 mb-4" > Asesoría constante.</h6>
               ...
               <div class="col-lg-3 col-sm-6 col-6">
                  <div style="max-width:300px;margin:auto">
                     ...
                     <h6 class="text-center font600 mb-4" > Software antiplagio.</h6>
                   ...
                   <div class="col-12 p-0">
                      ...
                      <div class="card" style="box-shadow:none">
                          <div class="card-body pt-0" >
                             ...
                             <div style="overflow:auto;max-height:600px;width:100%" class="fb-comments containerScroll" data-href="https://2vsoluciones.com/2v/" data-numposts="3" width="100%" data-width="100%" data-order-by="times"></div>
                          </div>
                      </div>
                      <br>
                      ...
                      <div class="text-center mt-2">
                          <a target="_blank" href="https://business.facebook.com/me.quiero.graduar.ya/?business_id=301312427099496"><img src="{{asset('public/images/default/redes sociales/logo-facebook.jpg')}}" alt="" style="border-radius:12px;max-width:40px;border:solid 2px white"></a>
