    ...
    <div class="container2">
        <div class="row m-auto" style="width:100%">
            ...
            <div class="col-12 col-lg-6 mb-3 col-xl-3 text-center">
                ...
                {{-- <p class="text-justify" style=" word-wrap: break-word;"><i class="far fa-envelope " style="font-size:30px !important"></i> <span class="font600">:</span> <br>   </p> --}}
            </div>
        </div>
    </div>
    <a href="https://www.sapienciaweb.com" target="_blank">
      <div id="footer-sap" class="mt-3">
        <h5 id="text-sap">Desarrollado por:
          <img style="width:25px;height:auto" src="{{asset('public/images/default/sapiencia/ico-sap.png')}}" alt="">Sapienciaweb.com</h5>
          {{-- <img id="loetras-sap" src="{{asset('public/images/default/sapiencia/letras.png')}}" alt=""> --}}
      </div>
    </a>
</div>
